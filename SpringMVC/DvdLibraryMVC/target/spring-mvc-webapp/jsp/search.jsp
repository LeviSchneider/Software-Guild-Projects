            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <form class='form-horizontal' role='form'>
                        ...
                        <div class='form-group'>
                            <label for='search-ratings' class='col-md-4 control-label'>Ratings:</label>
                            <div class='col-md-8'>
                                <input type='text' class='form-control' id='search-ratings' placeholder="Ratings"/>
                            </div>
                        </div>
                        <div class='form-group'>
                        ...
                        <div class='form-group'>
                            <div class='col-md-offset-4 col-md-8'>
                                <button type='submit' class='btn btn-default' id='search-button'>Add DVD</button>
                            </div>
                        </div>
                    </form>
                </div>
