...
public class Contact {
    ...
    @Length(max=20, message="Company must be no more than 20 characters in length.")
    private String company;
    @NotEmpty(message="You must supply a value for Phone number")
    @Length(max=10, message="Phone number must be no more than 10 characters in length.")//Try minimum after we are 
